...
const MajAvatar: React.FC<MajAvatarProps> = (props: MajAvatarProps) => {
      ...
      const makeAvatarWithIcon = <img className="maj-avatar-icon" src={circleUserIcon} alt="svg" />;

      const makeAvatarWithImage = <img src={props?.avatarURL} alt={props?.avatarALT} />;
